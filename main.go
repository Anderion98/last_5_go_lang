...
func (w Walking) Calories() float64 {
	// вставьте ваш код ниже
	var speedMS float64 = w.meanSpeed() * 1000 / 3600 // средняя_скорость_в_метрах_в_секунду
	result := math.Pow(speedMS, 2)                    // возведение в степень
	return (CaloriesWeightMultiplier*w.Weight + (result/w.Height)*CaloriesSpeedHeightMultiplier*w.Weight) * w.Duration.Hours() * MinInHours
}
...
func (w Walking) TrainingInfo() InfoMessage {
	// вставьте ваш код ниже
	return InfoMessage{TrainingType: w.TrainingType,
		Duration: w.Duration,
